...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(lazy: false, create: (context) => sl.get<SettingBloc>()),
        BlocProvider(lazy: false, create: (context) => sl.get<PrinterBloc>()),
      ],
      child: MaterialApp.router(
        ...
        theme: ThemeData(
          ...
          textTheme: Theme.of(
            context,
          ).textTheme.apply(fontSizeDelta: 0.8, fontSizeFactor: 0.8),
        ),
        routerConfig: router,
      ),
    );
