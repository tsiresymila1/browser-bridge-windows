...
abstract mixin class $MessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String sender, String body, int timestamp});
}
...
extension MessagePatterns on Message {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String sender, String body, int timestamp)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Message() when $default != null:
        return $default(_that.sender, _that.body, _that.timestamp);
      case _:
        return orElse();
    }
  }
...
class _Message implements Message {
  _Message({required this.sender, required this.body, required this.timestamp});
